...
@Configurable
public class BlueClose27AutoPathsMTI implements PathSupplier {
    /*
    NAMING CONVENTION:
    ...
    public static ColoredDecodePose SECOND_SPIKE_3 = new ColoredDecodePose(18.5, 63, Math.toRadians(180));
    ...
    public static ColoredDecodePose GATE_3 = new ColoredDecodePose(10.25, 59, Math.toRadians(152));
