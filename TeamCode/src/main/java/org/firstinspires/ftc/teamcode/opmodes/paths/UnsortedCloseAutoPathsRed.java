...
@Configurable
public class UnsortedCloseAutoPathsRed implements PathSupplier {
    ...
    public static ColoredDecodePose INTAKE_1 = new ColoredDecodePose(24, 61, Math.PI);
    public static ColoredDecodePose INTAKE_1_CONTROL = new ColoredDecodePose(45,61, Math.PI);
    ...
    public static ColoredDecodePose GATE = new ColoredDecodePose(14.25, 61, Math.toRadians(150));
    public static ColoredDecodePose GATE_1 = new ColoredDecodePose(13.75, 60, Math.toRadians(150));
    public static ColoredDecodePose GATE_2 = new ColoredDecodePose(14.25, 60, Math.toRadians(150));
    public static ColoredDecodePose GATE_3 = new ColoredDecodePose(14.75, 60, Math.toRadians(150));
    ...
    public List<FollowParameters> paths(Follower follower) {
        ...
        FollowParameters tapGate = new FollowParameters(Constants.DEFAULT_PROPORTIONAL, follower.pathBuilder()
                .addPath(ColoredDecodePose.makeBezier(INTAKE_1, GATE_TAP))
                .setConstantHeadingInterpolation(GATE_TAP.getHeading())
                .build()
        );
        ...
        return List.of(shootPreloads, intakeFirstSet, tapGate, shootFirstSet, intakeToGate.apply(0), shootFromGate.get(),
