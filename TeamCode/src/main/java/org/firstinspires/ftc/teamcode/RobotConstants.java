...
public class RobotConstants {
    public void build() {
        ...
        Turret.UNSORTED_AUTO_PRELOADS = 88; Turret.UNSORTED_GATE = 665; Turret.UNSORTED_FINAL = 740;
        Turret.UNSORTED_SET_1 = Turret.UNSORTED_GATE - 8; Turret.UNSORTED_SET_2 = Turret.UNSORTED_GATE + 5;
