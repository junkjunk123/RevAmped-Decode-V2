...
public class RobotConstants {
    public void build() {
        ...
        Turret.UNSORTED_AUTO_PRELOADS = 80; Turret.UNSORTED_GATE = 655; Turret.UNSORTED_FINAL = 708;
        Turret.FIFTEEN_BALL_PRELOADS = 67; Turret.FIFTEEN_OBELISK_DETECTION = -207;
