...
@Configurable
public class UnsortedCloseAutoPathsBlue implements PathSupplier {
    ...
    public static ColoredDecodePose GATE = new ColoredDecodePose(13.75, 60, Math.toRadians(150));
    public static ColoredDecodePose GATE_1 = new ColoredDecodePose(13.25, 59, Math.toRadians(150));
    public static ColoredDecodePose GATE_2 = new ColoredDecodePose(13.75, 58, Math.toRadians(150));
    public static ColoredDecodePose GATE_3 = new ColoredDecodePose(14.25, 59.5, Math.toRadians(150));
