        ...
        if (trackHood || trackTurret) {
            ...
            if (trackTurret) {
                ...
                if (!velocityCompensation) {
                    ...
                    deltaAngle = angleTurretTo(projectedDisplacement);
                }
            ...
            if (trackHood) {
                ...
                double yDist;
                if (!velocityCompensation) {
                    xDist = Math.abs(displacement.getXComponent());
                    yDist = Math.abs(displacement.getYComponent());
                } else {
                    xDist = Math.abs(projectedDisplacement.getXComponent());
                    yDist = Math.abs(projectedDisplacement.getYComponent());
                }
