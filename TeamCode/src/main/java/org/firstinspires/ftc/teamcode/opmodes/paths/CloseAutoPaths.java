...
public class CloseAutoPaths implements PathSupplier {
    ...
    public List<FollowParameters> paths(Follower follower) {
        FollowParameters initialShoot = new FollowParameters(Constants.DEFAULT_PROPORTIONAL, follower.pathBuilder()
        ...
        FollowParameters shootThirdSet = new FollowParameters(Constants.DEFAULT_PROPORTIONAL, follower.pathBuilder()
                .addPath(ColoredDecodePose.makeBezier(THIRD_INTAKE_END, THIRD_SHOOT))
                .setConstantHeadingInterpolation(THIRD_SHOOT.getHeading())
                .build()
        );

        FollowParameters goToStart = new FollowParameters(Constants.DEFAULT_PROPORTIONAL, follower.pathBuilder()
        ...
        FollowParameters parkNoPush = new FollowParameters(Constants.DEFAULT_PROPORTIONAL, follower.pathBuilder()
