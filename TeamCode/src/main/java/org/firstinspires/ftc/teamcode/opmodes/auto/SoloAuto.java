...
import org.firstinspires.ftc.teamcode.opmodes.paths.SoloAutoPathsWCI;
...
public class SoloAuto extends OpModeCommand {
    private Robot robot;
    ...
    public void initialize() {
        robot = new Robot(hardwareMap, new SoloAutoPathsWCI());
